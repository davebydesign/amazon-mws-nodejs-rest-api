...
class FinancesRequest  {
	ListFinancialEventGroups			(params) { return new FinancesRequestCall('ListFinancialEventGroups', 			params); }
	ListFinancialEventGroupsByNextToken			(params) { return new FinancesRequestCall('ListFinancialEventGroupsByNextToken', 			params); }
	ListFinancialEvents			(params) { return new FinancesRequestCall('ListFinancialEvents', 			params); }
	ListFinancialEventsByNextToken			(params) { return new FinancesRequestCall('ListFinancialEventsByNextToken', 			params); }
	GetServiceStatus			(params) { return new FinancesRequestCall('GetServiceStatus', 			params); }
}
